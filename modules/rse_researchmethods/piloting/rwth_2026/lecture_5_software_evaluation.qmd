...
# Kodiertechniken und LLMs

- einfache Kodierung mit MaxQDA und Auswertung dort
- Kodierung mit MaxQDA und Segmentanalyse mit Statistiksoftware (R)
- Kodierung mit MaxQDA als Goldstandard für LLM-Labeling
- LLM-Tournament:
  - Automatische Kodierung mittels LLMs
  - Deselektion derjenigen LLMs die systematisch daneben liegen
  - Kodierung der Stellen, wo sich drei LLMs unterscheiden
...
# The RIGHT framework [@dehne2026fairrightmethodologicalresearch]
...
- [G]eneration: Can the empirical results be synthetically generated to allow
for the simulation method?
- [H]uman-In-the-Loop: Are humans both users of the RS and part of the
research context?
- [T]ransformation: Does the RS transform the research context and forces
reinterpretation of the variables?
