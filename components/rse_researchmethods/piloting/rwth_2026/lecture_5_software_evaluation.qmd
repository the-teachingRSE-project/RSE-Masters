...
\footnotesize
\textbf{Zwei getrennte Studien:} SE evaluiert die Software (Objekt = Software/Qualität), EMP untersucht eine externe Forschungsfrage (Objekt = Lerneffekte, Verhalten etc.) mit der Software als Mittel. Quelle: ICSE-2027-Sekundärstudie zum DeLFI-Korpus.
...
+----------------------------+------------+------------+--------+--------+----------+---------+
| Typ                        | Fragebogen | Kontr.Exp. | Spuren | Review | Sensoren | Bericht |
+============================+============+============+========+========+==========+=========+
| Tool                       | 37         | 9          | 3      | 2      | 0        | 2       |
+----------------------------+------------+------------+--------+--------+----------+---------+
| System                     | 26         | 1          | 2      | 1      | 2        | 0       |
...
+----------------------------+------------+------------+--------+--------+----------+---------+
| Learning Management System | 8          | 0          | 3      | 0      | 0        | 0       |
+----------------------------+------------+------------+--------+--------+----------+---------+

\footnotesize
\textbf{Spaltenkürzel:} Kontr.Exp. = Kontrolliertes Experiment, Spuren = Verhaltensspuren, Review = Design Review, Sensoren = Kommerzielle Sensorsysteme, Bericht = Verbaler Bericht. Mehrfachnennungen pro Beitrag möglich; nur Beiträge mit mindestens einer zugeordneten Methode.
