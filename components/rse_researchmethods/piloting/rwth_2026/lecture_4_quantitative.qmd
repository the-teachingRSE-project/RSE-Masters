...
Die Anwendung von Methoden der Textanalyse basiert auf einigen Annahmen:
...
Quantitative — und zunehmend auch qualitative — computergestützte Inhaltsanalyse (oft als *Text als Daten* bezeichnet) hat in den letzten Jahren deutlich an Bedeutung gewonnen. Diese Entwicklung lässt sich auf mehrere Faktoren zurückführen:
...
| Skala      | Alle ein- eindeutigen T. | Alle  <br> streng monotonen T. | Alle <br> positiv linearen  T. | Alle Ähnlichkeitst. | Alle Identitätst. |
|------------|-------------------------:|-------------------------------:|-------------------------------:|--------------------:|------------------:|
